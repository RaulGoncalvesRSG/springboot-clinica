...
public class Medico extends AbstractEntity {
	...
	private Set<Especialidade> especialidades;				//Set evita especialidade repetida
	...
	//O médico TEM um usuário, para cadastrar um médico precisa ter um usuário existente
	...
	public Medico(Long id) {						//Método construtor com id do Medico
		super.setId(id);
	}

	public Medico(Usuario usuario) {				//Método construtor com obj Usuario
