...
public class EspecialidadeService {
	...
	public Map<String, Object> buscarEspecialidades(HttpServletRequest request) {
		datatables.setRequest(request);				//Passa o obj request para a classe Datatables
		datatables.setColunas(DatatablesColunas.ESPECIALIDADES);
		
		//getSearch signigica q o usuário fez uma consulta sem digitar algo no campo de busca
		//datatables.getSearch() é o conteúdo digitado no campo de consuçta
	...
	@Transactional(readOnly = true)				//Tabela de especialidades
