...
/*Classe para trabalhar com BD no lado servidor e selecionar os dados q quer enviar para a tabela de dados
 *no lado cliente. Essa classe é genérica, pode trabalhar com qualquer tipo de obj, ou seja, consulta de 
 *usuários, médicos, agendamentos, etc. */
@Component
public class Datatables {
	...
	//Valores q vieram a partir do request - informações da consulta referente à parte de ordenação e paginação
